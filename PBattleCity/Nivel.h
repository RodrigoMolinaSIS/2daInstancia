...
const unsigned char celdaSimbolo_GloboAerostatico = 'G';
...
const vAvatarDireccion vAvatarNingunaGloboAerostatico = {
	DatosSimboloConsola{(char)103, ColorConsola_Amarillo, ColorConsola_Rojo} };
const mAvatarDireccion avatarGloboAerostatico{ make_pair(Direccion{Direccion_Ninguna}, vAvatarNingunaGloboAerostatico) };
